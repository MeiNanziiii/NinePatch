...
public interface Items {
    ...
    Item craftingStationBuilder = new Item("crafting-station-builder", "workbench", new ItemProperties(){{
        craftedIn.add(
    ...
    Item shovel = new Item("shovel", "shovel1", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
    ...
    Item improvedShovel = new Item("shovel2", "shovel2", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        useAnimName = Anim.interactTool;
    ...
    Item pickaxe = new Item("pickaxe", "pickaxe", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        useAnimName = Anim.interactTool;
    ...
    Item axe = new Item("axe", "axe", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        useAnimName = Anim.interactTool;
    ...
    /* Item hammer = new Item("hammer", "missing", new ItemProperties(){{
        craftedIn.add(
    ...
    Item jackHammer = new Item("jackhammer", "jackhammer", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 2f;
    ...
    Item torchBuilder = new Item("torch-builder", "torch-item", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item crystalLampBuilder = new Item("crystallamp-builder", "crystal-lamp-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 8f;
    ...
    Item woodSignBuilder = new Item("woodsign-builder", "wood-sign", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item flagpoleBuilder = new Item("flagpole-builder", "flagpole-builder", new ItemProperties(){{
        craftTime = 1f;
        requires.add(new ItemStack(wood, 2));
    ...
    Item smelterBuilder = new Item("smelter-builder", "smelter", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item scienceLabBuilder = new Item("sciencelab-builder", "scilab-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item constructionYardBuilder = new Item("constructionyard-builder", "constructionyard", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 8f;
    ...
    Item wire = new Item("wire", "wire", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        maxCarry = 20;
    ...
    Item component = new Item("component", "component", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        maxCarry = 20;
    ...
    Item electronics = new Item("electronics", "electronics", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        maxCarry = 20;
    ...
    /* Item liquidTank = new Item("liquidtank", "", new ItemProperties(){{
        craftedIn.add(
                CraftedIn.craftingStation
        );
        maxCarry = 20;
    ...
    Item engine = new Item("engine", "engine", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        maxCarry = 10;
    ...
    Item woodFloorBuilder = new Item("woodfloor-builder", "woodfloor", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 2f;
    ...
    Item stoneWallBuilder = new Item("stonewall-builder", "stonewall-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftingQuantity = 3;
    ...
    Item metalWallBuilder = new Item("metalwall-builder", "metalwall-builder", new ItemProperties(){{
        craftedIn.add(
    ...
    Item gateBuilder = new Item("gate-builder", "gate-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftingQuantity = 1;
    ...
    /* Item dropper related things -------------------------------- */

    Item resin = new Item("resin", "resin", new ItemProperties(){{
        maxCarry = 20;
        craftedIn.add(
    ...
    Item seed = new Item("seed", "seed", new ItemProperties(){{
        growsInto = Plant.plant;
        maxCarry = 20;
        // craftTime = 200f;
    }});
    Item treeSeed = new Item("tree-seed", "tree-seed", new ItemProperties(){{
        maxCarry = 20;
        actions.add(
                new ItemDropperAction(ItemDroppers.treeSprout, 1f)
        );
    }});
    Item wood = new Item("wood", "wood", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item plant = new Item("plant", "plant", new ItemProperties(){{
        craftedIn.add(
                Crafter.gardenPatch
        );
        craftedIn.add(
    ...
    Item fruit = new Item("fruit", "fruit", new ItemProperties(){{
        maxCarry = 20;
        actions.add(
                new Action(ActionType.eat, 15f, Message.playerAteMessage)
        );
    }});
    Item rootSeed = new Item("root-seed", "root-seed", new ItemProperties(){{
        growsInto = Plant.root;
        maxCarry = 20;
        // craftTime = 200f;
    }});
    Item root = new Item("root", "root", new ItemProperties(){{
        craftedIn.add(
                Crafter.gardenPatch
        );
        craftedIn.add(
    ...
    Item blueshroom = new Item("blueshroom", "blueshroom", new ItemProperties(){{
        craftedIn.add(
                Crafter.greenhouse
        );
        maxCarry = 20;
    ...
    /* Item bluegoo = new Item("bluegoo", "bluegoo", new ItemProperties(){{
        craftedIn.add(
    ...
    Item blueshroomSeed = new Item("blueshroom-seed", "blueshroom-seed", new ItemProperties(){{
        // craftTime = 180f;
        growsInto = Plant.bluemushroom;
        maxCarry = 20;
    }});
    Item crystal = new Item("crystal", "crystal", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item chemical = new Item("chemical", "chemical", new ItemProperties(){{
        craftedIn.add(
                Crafter.chemistryLab
        );
        maxCarry = 20;
    ...
    Item batteryCell = new Item("batterycell", "batterycell", new ItemProperties(){{
        craftedIn.add(
                Crafter.chemistryLab
        );
        maxCarry = 20;
    ...
    /* Item glass = new Item("glass", "glass", new ItemProperties(){{
        craftedIn.add(
                CraftedIn.smelter
        );
        maxCarry = 10;
    ...
    Item ice = new Item("ice", "ice", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item scrap = new Item("scrap", "scrap", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item ore = new Item("ore", "ore", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item specialOre = new Item("special-ore", "special-ore", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item rock = new Item("rock", "rock", new ItemProperties(){{
        maxCarry = 20;
    }});
    /* Item sand = new Item("sand", "sand", new ItemProperties(){{
        maxCarry = 10;
    }}); */
    Item radioactiveOre = new Item("radioactive-ore", "radioactive-ore", new ItemProperties(){{
        maxCarry = 20;
    }});
    Item gasket = new Item("gasket", "gasket", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        maxCarry = 10;
    ...
    Item rockpileBuilder = new Item("rockpile-builder", "rockpile-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        maxCarry = 1;
    ...
    Item metal = new Item("metal", "metal-refined", new ItemProperties(){{
        craftedIn.add(
                Crafter.smelter
        );
        maxCarry = 20;
    ...
    Item metalBeam = new Item("metal-beam", "metal-beam", new ItemProperties(){{
        craftedIn.add(
                Crafter.smelter
        );
        maxCarry = 10;
    ...
    Item refinedScrap = new Item("refined-scrap", "refined-scrap", new ItemProperties(){{
        recyclable = false;
        craftedIn.add(
                Crafter.smelter
        );
    ...
    Item specialMetal = new Item("special-metal", "special-metal", new ItemProperties(){{
        recyclable = false;
        craftedIn.add(
                Crafter.smelter
        );
    ...
    Item nuclearFuel = new Item("nuclear-fuel", "nuclear-fuel", new ItemProperties(){{
        recyclable = false;
        craftedIn.add(
                Crafter.smelter
        );
    ...
    Item stonePathBuilder = new Item("stonepath-builder", "stonepath-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.smelter
        );
        craftTime = 2f;
    ...
    Item pavementBuilder = new Item("pavement-builder", "pavement", new ItemProperties(){{
        craftedIn.add(
                Crafter.smelter
        );
        craftTime = 2f;
    ...
    Item pavementStripedBuilder = new Item("pavement-striped-builder", "pavement-striped-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.smelter
        );
        craftTime = 0.5f;
    ...
    Item scienceScanner = new Item("sci-scanner1", "science-scanner", new ItemProperties(){{
        craftTime = 3f;
        requires.add(new ItemStack(scrap, 2));
        actions.add(
    ...
    Item drinkableWater = new Item("drink-water", "drinkable-water", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item food = new Item("food", "food", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item rootStew = new Item("rootstew", "rootstew", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item healingStew = new Item("healingstew", "healingstew", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item bigMeal = new Item("bigmeal", "bigmeal", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item creatureGuts = new Item("creature-guts", "creature-guts", new ItemProperties(){{
        maxCarry = 10;
    }});
    Item cookedGuts = new Item("cooked-guts", "creature-guts-cooked", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 12f;
    ...
    Item energyBar = new Item("energybar", "energybar", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item portableOxygen = new Item("portable-oxygen", "portable-oxygen", new ItemProperties(){{
        craftedIn.add(
                Crafter.chemistryLab
        );
        craftTime = 1f;
    ...
    Item repairKit = new Item("repair-kit", "repair-kit", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 2f;
    ...
    Item paintbrush = new Item("paintbrush", "paintbrush", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item batteryJumper = new Item("battery-jumper", "battery-jumper", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 2f;
    ...
    Item batteryJumperDead = new Item("battery-jumper-dead", "battery-jumper-dead", new ItemProperties(){{
        recyclable = false;
        craftTime = 0f;
        notStackable = true;
    }});
    Item gardenPathBuilder = new Item("gardenpatch-builder", "gardenpatch-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 6f;
    ...
    Item storageCrateBuilder = new Item("storage-crate-builder", "storage-crate-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item generatorBuilder = new Item("generator-builder", "generator", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item solarBuilder = new Item("solar-builder", "solar", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    /* Item wideSolarBuilder = new Item("wide-solar-builder", "temp-2x1", new ItemProperties(){{
        craftedIn.add(
    ...
    /* Item twoByTwoBuilder = new Item("twobytwo-builder", "temp-2x2", new ItemProperties(){{
        craftedIn.add(
                CraftedIn.constructionYard
        );
        craftTime = 4f;
    ...
    Item conduitBuilder = new Item("conduit-builder", "conduit-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item powerSwitchBuilder = new Item("powerswitch-builder", "powerswitch-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item lightsensorBuilder = new Item("lightsensor-builder", "lightsensor-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item batteryBuilder = new Item("battery-builder", "battery-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 4f;
    ...
    Item largeBatteryBuilder = new Item("battery2-builder", "battery2-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item habitatBuilder = new Item("habitat-builder", "habitat-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item airCleanerBuilder = new Item("aircleaner-builder", "aircleaner-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item airlockBuilder = new Item("airlock-builder", "airlock-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item autoAirlockBuilder = new Item("autoairlock-builder", "autoairlock-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 16f;
    ...
    Item storageContainerBuilder = new Item("storage-container-builder", "storage-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item chemistryLabBuilder = new Item("chemistrylab-builder", "chemistrylab-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    /* Item npcHomeBuilder = new Item("npchome-builder", "npchome-builder", new ItemProperties(){{
        craftTime = 8f;
        requires.add(new ItemStack(metal, 1));
        actions.add(
    ...
    Item floodlightBuilder = new Item("floodlight-builder", "floodlight", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    Item greenhouseBuilder = new Item("greenhouse-builder", "greenhouse-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item windTurbineBuilder = new Item("windturbine-builder", "windturbine-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    Item waterSupplyBuilder = new Item("watersupply-builder", "watersupply-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item garageBuilder = new Item("garage-builder", "garage", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    Item navigationLightBuilder = new Item("navlight-builder", "navlight", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 2f;
    ...
    Item communicationsTowerBuilder = new Item("commstower-builder", "commstower", new ItemProperties(){{
        craftTime = 4f;
        maxCarry = 4;
        craftedIn.add(
                Crafter.constructionYard
    ...
    Item medbayBuilder = new Item("medbay-builder", "medbay-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item recyclerBuilder = new Item("recycler-builder", "recycler", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    Item recyclerOrigBuilder = new Item("recycler-orig-builder", "recycler", new ItemProperties(){{
        craftTime = 4f;
        maxCarry = 10;
        requires.add(new ItemStack(metal, 1));
        actions.add(
    ...
    Item repairDroneBaseBuilder = new Item("repairdronebase-builder", "repairdronebase-builder", new ItemProperties(){{
        craftedIn.add(
    ...
    Item autocrafterBuilder = new Item("autocrafter-builder", "autocrafter-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 12f;
    ...
    Item miningRigBuilder = new Item("miningrig-builder", "miningrig-builder", new ItemProperties(){{
        craftTime = 8f;
        maxCarry = 4;
        craftedIn.add(
                Crafter.advancedFabricator
    ...
    Item rtgBuilder = new Item("rtg-builder", "rtg", new ItemProperties(){{
        maxCarry = 10;
        craftedIn.add(
                Crafter.constructionYard
        );
    ...
    Item lightningCollectorBuilder = new Item("lightningcollector-builder", "lightningcollector-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 4f;
    ...
    Item wallLightBuilder = new Item("walllight-builder", "walllight", new ItemProperties(){{
        craftTime = 4f;
        maxCarry = 10;
        requires.add(new ItemStack(metalBeam, 1));
        requires.add(new ItemStack(wire, 2));
    ...
    Item rainCollectorBuilder = new Item("raincollector-builder", "raincollector", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item autoRainCollectorBuilder = new Item("autoraincollector-builder", "autoraincollector-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item waterSpigotBuilder = new Item("waterspigot-builder", "waterspigot", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 1f;
    ...
    /* Item fluidTank = new Item("fluidtank", "fluidtank", new ItemProperties(){{
        craftedIn.add(
                Crafter.craftingStation
        );
        craftTime = 1f;
    ...
    Item buggie = new Item("buggie", "buggie-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.garage
        );
        recyclable = false;
    ...
    Item tank = new Item("tank", "tank-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.garage
        );
        recyclable = false;
    ...
    Item rover = new Item("rover", "cargo", new ItemProperties(){{
        recyclable = false;
        /* craftedIn.add(
                Crafter.garage
        ); */
    ...
    Item trailer = new Item("trailer", "trailer-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.garage
        );
        recyclable = false;
    ...
    Item explosive = new Item("explosive", "tnt", new ItemProperties(){{
        craftTime = 2f;
        requires.add(new ItemStack(rock, 2));
        actions.add(
    ...
    Item gravelBuilder = new Item("gravel-builder", "gravel-big", new ItemProperties(){{
        craftTime = 2f;
        craftingQuantity = 4;
        maxCarry = 32;
        requires.add(new ItemStack(rock, 4));
    ...
    Item workbenchHabitatBuilder = new Item("workbench-habitat-builder", "workbench-habitat-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 8f;
    ...
    Item biofuel = new Item("biofuel", "cargo", new ItemProperties(){{
        craftTime = 1f;
        craftingQuantity = 1;
        maxCarry = 20;
        requires.add(new ItemStack(plant, 3));
    ...
    Item advancedFabricatorBuilder = new Item("advancedfabricator-builder", "advancedfabricator", new ItemProperties(){{
        craftedIn.add(
                Crafter.constructionYard
        );
        craftTime = 24f;
    ...
    Item refineryBuilder = new Item("refinery-builder", "refinery-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 1f;
    ...
    Item fuelTankBuilder = new Item("fueltank-builder", "fueltank-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 1f;
    ...
    Item launchpadBuilder = new Item("launchpad-builder", "launchpad-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 1f;
    ...
    Item rocketEngine = new Item("rocketengine", "rocketengine", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 24f;
    ...
    Item rocketHull = new Item("rockethull", "rockethull", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 48f;
    ...
    Item flightControls = new Item("flightcontrols", "flightcontrols", new ItemProperties(){{
        craftedIn.add(
                Crafter.advancedFabricator
        );
        craftTime = 48f;
    ...
    Item rocket = new Item("rocket", "rocket-builder", new ItemProperties(){{
        craftedIn.add(
                Crafter.launchpad
        );
        craftTime = 32f;
    ...
    Item magicPowerBuilder = new Item("magic-power-builder", "magic", new ItemProperties(){{
        craftTime = 1f;
        maxCarry = 99;
        actions.add(
    ...
    Item researchObject = new Item("researchObject", "artifact", new ItemProperties(){{
        recyclable = false;
        researchPoints = 5;
        notStackable = true;
    }});

    static String getId(Item item) {
        return item.id;
    }
}
